...
// console.log(normalizeAuthorName('ARthur LucAs'));
...
const firstbooks = new Map(Object.entries(books[0]));
console.log(firstbooks);

for (const [keys, values] of firstbooks) {
