...
const account1 = {
  ...
  movementsDates: [
    ...
    '2024-11-22T14:43:26.374Z',
    '2025-02-05T16:33:06.386Z',
    '2025-09-13T18:49:59.371Z',
    '2025-09-16T12:01:20.894Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
    ...
    const html = `
      ...
      i + 1
       ...
       <div class="movements__date">${displayDate}</div>
        <div class="movements__value">${formateddMov}</div>
      </div>
    `;
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // labelDate.textContent = `${date}/${mounth}/${year}, ${hrs}:${minutes}`;
...
//Parsing
console.log(Number.parseFloat('12ax25'));
